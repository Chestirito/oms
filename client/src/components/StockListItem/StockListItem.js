...
return (
    ...
    <span className = "title">  % Change: </span><span className = "datainfo stockchange" style = {stock.change > "0" ? {color: '#39FF14'} : {color:'#C11B17'}} > { parseFloat(stock.change).toFixed(4)}%</span>
